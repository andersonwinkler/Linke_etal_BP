...
The matrices and the clinical data can now be analyzed with c01_cca.m. Finally, CVs are compared between the diagnostic categories included in this study for both dataets: c02_compare_DX_CMI.m and c02_compare_DX_NIMH.m
